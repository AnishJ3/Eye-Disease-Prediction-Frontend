        ...
        <>
            ...
            <section className="welcome">
                <div className="welcome-container">
                    ...
                    <p className="welcome-text">Welcome to Eye Care!</p>
                ...
                <p className="speciality-title">Our Specialities</p>
                    ...
                    <div className="speciality-items">
                        ...
                        <div className="speciality-card">
                            ...
                            diagnosis for Glaucome looking at fundus images of eyes</p>
                            {arr[0] && 
                            <>
                        ...
                        <div className="speciality-learn-items">
                            ...
                            <>  
                                <div className="speciality-box">
                                    ...
                                    Overview. Diabetes is a chronic disease that occurs either when the 
